...
using esxl.Forms.Dialogs;
using esxl.Forms.Docking;
using esxl.Helpers;
 


// Ensure that the DockProject class is defined in the esxl.ui.Docking namespace or another namespace that is imported.
using System;
...
namespace esxl.ui
{
    ...
    {   
        ...
        {
            DockDocument newFile = new("New document", Resources.document_16xLG);
